...
window.phet.preloads.phetio.phetioTypes = assert &&
  {
    ...
    "DerivedPropertyIO<RangeIO>": {
      ...
      "supertype": "PropertyIO<RangeIO>",
      "typeName": "DerivedPropertyIO<RangeIO>"
    },
    "DialogIO": {
    ...
    "EnumerationIO(LEFT|RIGHT)": {
      "documentation": "Possible values: LEFT,RIGHT.",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "supertype": "ObjectIO",
      "typeName": "EnumerationIO(LEFT|RIGHT)"
    },
    ...
    "FunctionIO(EnumerationIO(LEFT|RIGHT),NullableIO<EnumerationIO(LEFT|RIGHT)>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> EnumerationIO(LEFT|RIGHT), NullableIO<EnumerationIO(LEFT|RIGHT)><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
        "EnumerationIO(LEFT|RIGHT)",
        "NullableIO<EnumerationIO(LEFT|RIGHT)>",
        "VoidIO"
      ],
      "supertype": "ObjectIO",
      "typeName": "FunctionIO(EnumerationIO(LEFT|RIGHT),NullableIO<EnumerationIO(LEFT|RIGHT)>)=>VoidIO"
    },
    ...
    "FunctionIO(NullableIO<ReferenceIO<BunnyIO>>,NullableIO<NullableIO<ReferenceIO<BunnyIO>>>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> NullableIO<ReferenceIO<BunnyIO>>, NullableIO<NullableIO<ReferenceIO<BunnyIO>>><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
        "NullableIO<ReferenceIO<BunnyIO>>",
        "NullableIO<NullableIO<ReferenceIO<BunnyIO>>>",
        "VoidIO"
      ],
      "supertype": "ObjectIO",
      "typeName": "FunctionIO(NullableIO<ReferenceIO<BunnyIO>>,NullableIO<NullableIO<ReferenceIO<BunnyIO>>>)=>VoidIO"
    },
    "FunctionIO(NullableIO<SceneryEventIO>)=>VoidIO": {
    ...
    "FunctionIO(NullableIO<StringIO>,NullableIO<NullableIO<StringIO>>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> NullableIO<StringIO>, NullableIO<NullableIO<StringIO>><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
        "NullableIO<StringIO>",
        "NullableIO<NullableIO<StringIO>>",
        "VoidIO"
      ],
      "supertype": "ObjectIO",
      "typeName": "FunctionIO(NullableIO<StringIO>,NullableIO<NullableIO<StringIO>>)=>VoidIO"
    },
    ...
    "FunctionIO(ReferenceIO<BunnyIO>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> ReferenceIO<BunnyIO><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
      ...
      "supertype": "ObjectIO",
      "typeName": "FunctionIO(ReferenceIO<BunnyIO>)=>VoidIO"
    },
    ...
    "NullableIO<EnumerationIO(LEFT|RIGHT)>": {
      ...
      "supertype": "ObjectIO",
      "typeName": "NullableIO<EnumerationIO(LEFT|RIGHT)>"
    },
    "NullableIO<EnumerationIO(POPULATION|PROPORTIONS|PEDIGREE)>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
    ...
    "NullableIO<NullableIO<ReferenceIO<BunnyIO>>>": {
      ...
      "supertype": "ObjectIO",
      "typeName": "NullableIO<NullableIO<ReferenceIO<BunnyIO>>>"
    },
    "NullableIO<NullableIO<StringIO>>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
      ...
      "supertype": "ObjectIO",
      "typeName": "NullableIO<NullableIO<StringIO>>"
    },
    "NullableIO<NumberIO>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
    ...
    "NullableIO<ReferenceIO<BunnyIO>>": {
      ...
      "supertype": "ObjectIO",
      "typeName": "NullableIO<ReferenceIO<BunnyIO>>"
    },
    "NullableIO<SceneryEventIO>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
    ...
    "ObservableArrayIO<ReferenceIO<BunnyIO>>": {
    ...
    "PropertyIO<EnumerationIO(LEFT|RIGHT)>": {
      "documentation": "Observable values that send out notifications when the value changes. This differs from the traditional listener pattern in that added listeners also receive a callback with the current value when the listeners are registered. This is a widely-used pattern in PhET-iO simulations.",
      "events": [
        "changed"
      ],
      ...
      "methods": {
        "getValue": {
          "documentation": "Gets the current value.",
          "parameterTypes": [],
          "returnType": "EnumerationIO(LEFT|RIGHT)"
        },
        "lazyLink": {
          "documentation": "Adds a listener which will be called when the value changes. This method is like \"link\", but without the current-value callback on registration. The listener takes two arguments, the new value and the previous value.",
          "parameterTypes": [
      ...
      "supertype": "ObjectIO",
      "typeName": "PropertyIO<EnumerationIO(LEFT|RIGHT)>"
    },
    "PropertyIO<EnumerationIO(POPULATION|PROPORTIONS|PEDIGREE)>": {
      ...
      "methods": {
        "getValue": {
          "documentation": "Gets the current value.",
          "parameterTypes": [],
          "returnType": "EnumerationIO(POPULATION|PROPORTIONS|PEDIGREE)"
        },
        "lazyLink": {
          "documentation": "Adds a listener which will be called when the value changes. This method is like \"link\", but without the current-value callback on registration. The listener takes two arguments, the new value and the previous value.",
          "parameterTypes": [
    ...
    "PropertyIO<NullableIO<ReferenceIO<BunnyIO>>>": {
      "documentation": "Observable values that send out notifications when the value changes. This differs from the traditional listener pattern in that added listeners also receive a callback with the current value when the listeners are registered. This is a widely-used pattern in PhET-iO simulations.",
      "events": [
        "changed"
      ],
      ...
      "methods": {
        "getValue": {
          "documentation": "Gets the current value.",
          "parameterTypes": [],
          "returnType": "NullableIO<ReferenceIO<BunnyIO>>"
        },
        "lazyLink": {
          "documentation": "Adds a listener which will be called when the value changes. This method is like \"link\", but without the current-value callback on registration. The listener takes two arguments, the new value and the previous value.",
          "parameterTypes": [
      ...
      "supertype": "ObjectIO",
      "typeName": "PropertyIO<NullableIO<ReferenceIO<BunnyIO>>>"
    },
    "PropertyIO<NullableIO<StringIO>>": {
      "documentation": "Observable values that send out notifications when the value changes. This differs from the traditional listener pattern in that added listeners also receive a callback with the current value when the listeners are registered. This is a widely-used pattern in PhET-iO simulations.",
      "events": [
        "changed"
      ],
      ...
      "supertype": "ObjectIO",
      "typeName": "PropertyIO<NullableIO<StringIO>>"
    },
    "PropertyIO<NumberIO>": {
      "documentation": "Observable values that send out notifications when the value changes. This differs from the traditional listener pattern in that added listeners also receive a callback with the current value when the listeners are registered. This is a widely-used pattern in PhET-iO simulations.",
      "events": [
