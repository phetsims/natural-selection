...
simLauncher.launch( () => {
  ...
  const sim = new Sim( NaturalSelectionStrings[ 'natural-selection' ].titleStringProperty, screens, {
    ...
    credits: {
      ...
      qualityAssurance: 'Logan Bray, Steele Dalton, Jaron Droder, Clifford Hardin, Brooklyn Lash, Emily Miller, Liam Mulhall, Devon Quispe, Nancy Salpepi, Kathryn Woessner',
