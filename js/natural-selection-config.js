 ...
 * please modify natural-selection/package.json to control dependencies.
 *
 * RequireJS configuration file for the natural-selection sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'natural-selection-main' ],
