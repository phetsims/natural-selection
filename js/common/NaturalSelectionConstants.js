...
define( require => {
  ...
  const NaturalSelectionConstants = {
    ...
    ENVIRONMENT_DISPLAY_NODE_SIZE: new Dimension2( 770, 310 ),
    ENVIRONMENT_DISPLAY_NODE_HORIZON_Y: 95, // where the horizon is, determined empirically from background PNG files //TODO move to model
    ENVIRONMENT_DISPLAY_NODE_X_MARGIN: 15, // margins at left and right edges of the viewport
    ENVIRONMENT_DISPLAY_NODE_Y_MARGIN: 15, // margins at top and bottom edges of the viewport
